...
function quantidadeVitorias(vitorias) {
...
let nivel = quantidadeVitorias(saldoVitorias)

console.log(`A heroína tem de saldo ${saldoVitorias} vitórias e está no nível ${nivel}`)